        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.status = 'success') {
              ...
              (0, _alert.showAlert)('sucess', 'Logged out success');
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Logging out error. Try again');
...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWF4N29zdCIsImEiOiJja2l0YTdqZWQwbWpsMnZtbTVocnl6cnB5In0.9D-gFiX1QyGq6pjwNHMywQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 15
    }).setLngLat(loc.coordinates).setHTML("<p>Days: ".concat(loc.day, " <br /> ").concat(loc.description, "</p>")).addTo(map);
...
function _updateSettings() {
  _updateSettings = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', "".concat(_context.t0.message, ". Try again"));
...
var stripe = Stripe('pk_test_5RStTWVlGBc4ajEqN8UhsV4300UtmJmKmB');
...
var passwordDataForm = document.querySelector('.form-user-password');
var bookTourBtn = document.getElementById('book-tour'); // Dom values
//Delegetion
...
if (passwordDataForm) {
  passwordDataForm.addEventListener('submit', /*#__PURE__*/function () {
